...
/// Processor for creating a mask of hair in an image.
///
...
@interface PNKHairSegmentationProcessor : NSObject
...
/// Create a segmentation mask corresponding to hair in \c input.
///
