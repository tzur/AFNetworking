...
@interface LLSignalTestRecorderTests : XCTestCase
@end
...
- (void) test_recorderAccumulatesThreads {
  ...
  // GCD may use multiple threads to deliver the values, or just a single thread, depending on its
  // implementation.
  expect(recorder.operatingThreadsCount).will.beGreaterThanOrEqualTo(1);
