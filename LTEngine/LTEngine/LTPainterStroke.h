...
/// Initializes a stroke with the given interpolant factory, starting at the given point. The
/// factory will be used to generate segments when new points are added to the stroke, controlling
/// the type of segments consisting the stroke.
...
/// Returns \c nil if no segment is generated (again, for some interpolant types that require a
/// window).
