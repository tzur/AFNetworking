...
/// Renders the given \c rotatedRects into an already bound framebuffer, after applying the current
/// brush effects to the \c rotatedRects. The bound framebuffer is assumed to have the given
/// \c size. Returns the rotated rects after applying the brush effects.
