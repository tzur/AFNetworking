...
/// there was an error while fetching the content or if the given \c contentFetcherParameters is
/// invalid.
///
...
/// signal completes after sending the value. The signal errs if the given
