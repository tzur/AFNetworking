...
@property (readonly, nonatomic, nullable) NSArray<NSString *> *purchasedProducts;

/// List of products that were acquired by the user via subscription on the current device.
@property (readonly, nonatomic, nullable) NSArray<NSString *> *acquiredViaSubscriptionProducts;

/// List of products that were purchased by the user. This includes in-app purchases on all devices
...
@property (readonly, nonatomic, nullable) NSArray<NSString *> *acquiredProducts;

/// List of products that the user is allowed to use.
@property (readonly, nonatomic, nullable) NSArray<NSString *> *productsAllowedToBeUsed;
...
@property (readonly, nonatomic) NSArray<NSString *> *productsWithDownloadedContent;
