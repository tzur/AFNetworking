...
/// List of products that were purchased by the user as in-app purchases. KVO-compliant.
...
/// without content will be in the list as well. KVO-compliant.
@property (readonly, nonatomic) NSSet<NSString *> *downloadedContentProducts;

/// Subscription information of the user. KVO-compliant.
@property (readonly, nonatomic, nullable) BZRReceiptSubscriptionInfo *subscriptionInfo;

/// Status of the latest receipt validation. KVO-compliant.
