...
/// RGB color, in premultiplied format, forwarded to the fragment shader, in case that
/// \c sampleUniformColorFromColorTexture is \c NO.
...
void main() {
  vPremultipliedColor = vec4(color, 1.0);
