...
@protocol DVNAttributeProviderModel, DVNQuadProviderOutput;
...
/// Returns attribute data to be associated with the \c quads of the given \c output. The returned
...
- (LTAttributeData *)attributeDataFromQuadProviderOutput:(id<DVNQuadProviderOutput>)output;
