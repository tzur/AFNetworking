...
/// Write color gradient values to texture.
///
/// @param number number of points to sample the gradient. Number of points should be at least two.
/// First point samples at 0.0, last one at 1.0. Using low number of sampling points can result in
/// an inadequate representation of the gradient.
///
