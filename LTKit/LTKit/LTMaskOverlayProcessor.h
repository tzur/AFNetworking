...
/// channel image, allowing its [0, 1] grayscale color to be replaced with an RGB color using the
/// \c maskColor property. The opacity of the mask on top of the image can also be controlled, via
/// the alpha value of the \c maskColor.
...
/// be:
/// @code
/// (1 - mask.r * maskColor.a) * image.rgb +
