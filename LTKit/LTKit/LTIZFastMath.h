...
NS_INLINE uint32_t LTSignedToUnsigned(int32_t value) {
...
/// Returns the zero-based index of the most significant bit that is equal to 1. If \c value is \c 0,
/// the returned value is undefined.
NS_INLINE uint32_t LTBitScanReversed(uint32_t value) {
