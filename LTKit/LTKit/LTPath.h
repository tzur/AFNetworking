...
/// \c relativePath is converted to absolute path (by adding a leading '/'). The path will be
/// constructed by resolving the path of the concatenated base directory and the relative path.
