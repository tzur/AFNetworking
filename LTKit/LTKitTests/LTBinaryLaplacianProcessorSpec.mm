...
SpecBegin(LTBinaryLaplacianProcessor)
...
it(@"should produce correct result with RGBA8", ^{
  cv::Mat4b image(48, 48, cv::Vec4b(0, 0, 0, 255));
  cv::Rect rect(16, 16, 16, 16);
  ...
  LTBinaryLaplacianProcessor *processor = [[LTBinaryLaplacianProcessor alloc] initWithInput:input
                                                                                     output:output];
