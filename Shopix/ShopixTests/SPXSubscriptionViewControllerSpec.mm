...
/// Fake mail composer for testing.
@interface SPXFakeMailComposeViewController : UIViewController <SPXMailComposeViewController>
@end

@implementation SPXFakeMailComposeViewController
