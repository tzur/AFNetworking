...
/// privacy-policy URLs are set by \c fullTermsURL and \c privacyPolicyURL.
...
/// URLs are set by \c fullTermsURL and \c privacyPolicyURL.
- (instancetype)initWithTermsOverview:(NSString *)termsOverview
                            fullTerms:(NSURL *)fullTermsURL
                        privacyPolicy:(NSURL *)privacyPolicyURL NS_DESIGNATED_INITIALIZER;
