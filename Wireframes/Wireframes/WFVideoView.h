...
/// failed).
@property (readonly, nonatomic, nullable) NSURL *currentVideoURL;
...
/// Current time of the current video. If \c currentVideoURL is \c nil, \c 0 is returned. This
/// property is not key-value observable. The \c delegate is being notified periodically of changes
/// in this property and can be used for observing it.
@property (readonly, nonatomic) NSTimeInterval currentTime;

/// Current video duration. If \c currentVideoURL is \c nil, \c 0 is returned.
@property (readonly, nonatomic) NSTimeInterval videoDuration;

/// Size of the current video. If \c currentVideoURL is \c nil, \c CGSizeZero is returned.
