...
- (RACSignal<LTProgress<id<PTNImageAsset>> *> *)
...
- (RACSignal<LTProgress<id<PTNAudiovisualAsset>> *> *)
...
///
/// The returned signal sends \c LTProgress objects on a arbitrary thread, complete once the final
...
/// progress.
- (RACSignal<LTProgress<id<PTNImageDataAsset>> *> *)
