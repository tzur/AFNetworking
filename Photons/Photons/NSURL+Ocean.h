...
///   - Assets album: <ocean scheme>://album?phrase=<phrase>&source=<source identifier>&page=<page>
...
/// Initializes an album URL with the given \c source, \c phrase and \c page. If \c phrase is
/// \c nil, the returned URL will be associated with the album of the most popular assets. Albums
/// backed by URLs returned from this method are paginated. Use the given \c page to specify the
/// page number.
+ (NSURL *)ptn_oceanAlbumURLWithSource:(PTNOceanAssetSource *)source
